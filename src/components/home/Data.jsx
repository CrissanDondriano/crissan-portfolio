...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Crissan Dondriano
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I'm creative developer based in Philippines, and I'm very passionate and dedicated to my word.</p>

            <a href="#contact" className="button button--flex">Message Me
                <svg
                    class="button__icon"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
